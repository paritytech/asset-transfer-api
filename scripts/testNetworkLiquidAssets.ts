...
const main = async () => {
	...
	hrmpChannelCalls.push(openHrmpChannels(relayApi, Number(1000), Number(3000)));
	hrmpChannelCalls.push(openHrmpChannels(relayApi, Number(1000), Number(4000)));
	hrmpChannelCalls.push(openHrmpChannels(relayApi, Number(3000), Number(1000)));
	hrmpChannelCalls.push(openHrmpChannels(relayApi, Number(3000), Number(4000)));
	hrmpChannelCalls.push(openHrmpChannels(relayApi, Number(4000), Number(1000)));
	hrmpChannelCalls.push(openHrmpChannels(relayApi, Number(4000), Number(3000)));
