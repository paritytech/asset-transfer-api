...
describe('checkParaToEthereum', () => {
	...
	it ('Should correctly throw an error when destAddress is not an ethereum address', () => {
		const err = () => checkParaToEthereum(substrateAccountAddress, '7KqMfyEXGMAgkNGxiTf3PNgKqSH1WNghbAGLKezYyLLW4Zp1', undefined);
	...
	it('Should correctly throw an error when paysWithFeeDest is not provided', () => {
		const err = () => checkParaToEthereum(ethereumAccountAddress, '7KqMfyEXGMAgkNGxiTf3PNgKqSH1WNghbAGLKezYyLLW4Zp1', undefined);
