...
/**
 * In this example we are creating a `polkadotXcm` pallet `transferAssets` call to send MOVR (foreign asset with location `{"parents":"1","interior":{"X2":[{"Parachain":"2125"},{"GeneralIndex":"0"}]}}`)
