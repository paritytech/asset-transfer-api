			...
			describe('V2', () => {
				...
				it('Should correctly build a call for a teleportAssets for V2', () => {
					...
					expect(res).toEqual({
						...
						tx: '0x1f0101010100411f0100010100f5d5714c084c112843aca74f8c498da06cc5a2d63153b825189baa51043b1f0b010400010000910100000000',
						xcmVersion: 2,
					});
				});
				it('Should correctly build a payload for a teleportAssets for V2', () => {
					...
					expect(res).toEqual({
						...
						format: 'payload',
						method: 'teleportAssets',
						tx: '',
						xcmVersion: 2,
					});
				});
				it('Should correctly build a submittable extrinsic for a teleportsAssets for V2', () => {
				...
				it('Should correctly build a call for limitedTeleportAssets for V2', () => {
					...
					expect(res).toEqual({
						...
						tx: '0x1f0901010100411f0100010100f5d5714c084c112843aca74f8c498da06cc5a2d63153b825189baa51043b1f0b01040001000091010000000000',
						xcmVersion: 2,
					});
				});
				it('Should correctly build a payload for limitedTeleportAssets for V2', () => {
					...
					expect(res).toEqual({
						...
						format: 'payload',
						method: 'limitedTeleportAssets',
						tx: '',
						xcmVersion: 2,
					});
				});
				it('Should correctly build a submittable extrinsic for a limitedTeleportsAssets for V2', () => {
			...
			describe('V3', () => {
				...
				it('Should correctly build a call for a teleportAssets for V3', () => {
					...
					expect(res).toEqual({
						...
						format: 'call',
						method: 'teleportAssets',
						tx: '0x1f0103010100411f0300010100f5d5714c084c112843aca74f8c498da06cc5a2d63153b825189baa51043b1f0b030400010000910100000000',
						xcmVersion: 3,
					});
				});
				it('Should correctly build a payload for a teleportAssets for V3', () => {
					...
					expect(res).toEqual({
						...
						format: 'payload',
						method: 'teleportAssets',
						tx: '',
						xcmVersion: 3,
					});
				});
				it('Should correctly build a submittable extrinsic for a teleportsAssets for V3', () => {
				...
				it('Should correctly build a call for limitedTeleportAssets for V3', () => {
					...
					expect(res).toEqual({
						...
						format: 'call',
						method: 'limitedTeleportAssets',
						tx: '0x1f0903010100411f0300010100f5d5714c084c112843aca74f8c498da06cc5a2d63153b825189baa51043b1f0b03040001000091010000000000',
						xcmVersion: 3,
					});
				});
				it('Should correctly build a payload for limitedTeleportAssets for V3', () => {
					...
					expect(res).toEqual({
						...
						format: 'payload',
						method: 'limitedTeleportAssets',
						tx: '',
						xcmVersion: 3,
					});
				});
				it('Should correctly build a submittable extrinsic for a limitedTeleportsAssets for V3', () => {
