...
/**
 * In this example we are creating a `polkadotXcm` pallet `transferAssetsUsingTypeAndThen` call to send 1 KSM (asset with location `{"parents":"0","interior":{"Here":""}}`)
 ...
 * are both set to the `RemoteReserve` location of Kusama AssetHub, specifying that the reserve location to be used for transferring and fees is Kusama AssetHub.
 *
