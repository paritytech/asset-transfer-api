...
/**
 * In this example we are creating a `polkadotXcm` pallet `limitedReserveTransferAssets` call to send EQ (foreign asset with location '{"parents":"1","interior":{"X1":{"Parachain":"2011"}}}')
