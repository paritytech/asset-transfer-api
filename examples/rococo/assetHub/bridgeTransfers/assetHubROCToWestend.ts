...
/**
 * In this example we are creating a `polkadotXcm` pallet `transferAssetsUsingTypeAndThen` call to send ROC (foreign asset with location `{"parents":"1","interior":{"Here":""}}`)
