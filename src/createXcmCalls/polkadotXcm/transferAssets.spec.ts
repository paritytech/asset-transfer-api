...
describe('transferAssets', () => {
	...
	describe('SystemToPara', () => {
		...
		it('Should correctly construct a foreign asset tx for a system parachain with V4', async () => {
			...
			expect(ext.toHex()).toBe(
				'0xfc041f0b040101009d1f0400010100f5d5714c084c112843aca74f8c498da06cc5a2d63153b825189baa51043b1f0b04040102003d1105000091010000000000',
			);
		});
		...
		it('Should correctly construct a foreign asset tx when a weightLimit is available', async () => {
			...
			expect(ext.toHex()).toBe(
				'0x1501041f0b040101009d1f0400010100f5d5714c084c112843aca74f8c498da06cc5a2d63153b825189baa51043b1f0b04040102003d110500009101000000000102286bee411f',
			);
		});
	});
});
