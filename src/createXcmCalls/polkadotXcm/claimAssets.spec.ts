...
describe('claimAssets', () => {
    it('Should correctly construct an XCM V4 claimAssets call', async () => {
        ...
        expect(ext.toHex()).toEqual('0xd8041f0c04040102043205011f0002093d000400010100f5d5714c084c112843aca74f8c498da06cc5a2d63153b825189baa51043b1f0b');
    });
    it('Should correctly construct an XCM V3 claimAssets call', async () => {
        ...
        expect(ext.toHex()).toEqual('0xdc041f0c0304000102043205011f0002093d000300010100f5d5714c084c112843aca74f8c498da06cc5a2d63153b825189baa51043b1f0b');
    });
    it('Should correctly construct an XCM V2 claimAssets call', async () => {
        ...
        expect(ext.toHex()).toEqual('0xdc041f0c0104000102043205011f0002093d000100010100f5d5714c084c112843aca74f8c498da06cc5a2d63153b825189baa51043b1f0b');
    });
});