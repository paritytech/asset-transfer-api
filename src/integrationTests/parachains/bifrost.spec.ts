					...
					const tests: TestMultiasset[] = [
						[
							...
							'bnc',
							{
								...
								tx: '',
								xcmVersion: 2,
							},
						],
						[
					...
					const tests: TestMultiasset[] = [
						[
							...
							'bnc',
							{
								...
								format: 'payload',
								method: 'transferMultiasset',
								tx: '',
								xcmVersion: 3,
							},
						],
						[
					...
					const tests: TestMultiasset[] = [
						[
							...
							'bnc',
							{
								...
								tx: '',
								xcmVersion: 2,
							},
						],
						[
					...
					const tests: TestMultiassetWithFormat[] = [
						[
							...
							'call',
							{
								...
								format: 'call',
								method: 'transferMultiasset',
								tx: '0x460101000000000700e40b540201010200a10f01007369626c2708000000000000000000000000000000000000000000000000000001a10f411f',
								xcmVersion: 2,
							},
						],
						[
							...
							'payload',
							{
								...
								format: 'payload',
								method: 'transferMultiasset',
								tx: '',
								xcmVersion: 2,
							},
						],
					];
					...
					const tests: TestMultiassetWithFormat[] = [
						[
							...
							'call',
							{
								...
								format: 'call',
								method: 'transferMultiasset',
								tx: '0x460103000000000700e40b540203010200a10f01007369626c2708000000000000000000000000000000000000000000000000000001a10f411f',
								xcmVersion: 3,
							},
						],
						[
							...
							'payload',
							{
								...
								format: 'payload',
								method: 'transferMultiasset',
								tx: '',
								xcmVersion: 3,
							},
						],
					];
