...
const main = async () => {
	...
	console.log(
		'WHAT IS PAYLOAD', payload
	)

	const feeEstimate = await assetTransferApi.fetchFeeInfo(payload.tx, 'payload');
	...
	// );
	// const payloadJSON = payloadExtrinsic.method.toJSON() as string;
